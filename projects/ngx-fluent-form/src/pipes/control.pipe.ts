...
export class FluentControlPipe implements PipeTransform {
   ...
   */
  transform(value: SchemaKey | undefined, container: FormGroup | FormArray, type: 'control'): FormControl;
  transform(value: SchemaKey | undefined, container: FormGroup | FormArray, type: 'group'): FormGroup;
  transform(value: SchemaKey | undefined, container: FormGroup | FormArray, type: 'array'): FormArray;
  transform(value: SchemaKey | undefined, container: FormGroup | FormArray): AbstractControl;
  transform(value: SchemaKey | undefined, container: FormGroup | FormArray): AbstractControl {
    ...
    return container.get([Array.isArray(value) ? value.toString() : value as SingleSchemaKey]) ?? container;
