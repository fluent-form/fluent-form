...
export class FluentControlPipe implements PipeTransform {
   ...
   */
  transform(value: AnySchemaKey | undefined, container: FormGroup | FormArray, type: 'control'): FormControl;
  transform(value: AnySchemaKey | undefined, container: FormGroup | FormArray, type: 'group'): FormGroup;
  transform(value: AnySchemaKey | undefined, container: FormGroup | FormArray, type: 'array'): FormArray;
  transform(value: AnySchemaKey | undefined, container: FormGroup | FormArray): AbstractControl;
  transform(value: AnySchemaKey | undefined, container: FormGroup | FormArray): AbstractControl {
    ...
    return container.get([Array.isArray(value) ? value.toString() : value as SchemaKey]) ?? container;
